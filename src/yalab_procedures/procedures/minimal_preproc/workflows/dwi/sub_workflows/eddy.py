...
from yalab_procedures.procedures.minimal_preproc.workflows.dwi.sub_workflows.extract_b0 import (
    init_extract_b0_wf,
)


def init_eddy_wf(name: str = "eddy_wf", nthreads: int = 1) -> pe.Workflow:
    """
    ...
    dwi_b0_extractor = init_extract_b0_wf(name="dwi_b0_extractor", nthreads=nthreads)
    fmap_b0_extractor = init_extract_b0_wf(name="fmap_b0_extractor", nthreads=nthreads)
