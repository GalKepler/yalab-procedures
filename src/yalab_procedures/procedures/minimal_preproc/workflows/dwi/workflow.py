...
from yalab_procedures.procedures.minimal_preproc.workflows.dwi.sub_workflows.post_eddy import (
    init_post_eddy_wf,
)
...
def init_dwi_preproc_wf(
    ...
    fieldmap = get_fieldmap(dwi_file, subject_data)
    ...
    dwi_conversion_to_mif_node = pe.Node(
        interface=mrt.MRConvert(out_file="dwi.mif", nthreads=nthreads),
        name="dwi_mifconv",
    )
